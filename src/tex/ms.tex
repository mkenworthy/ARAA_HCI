...
Bioactive molecules see reviews of \citet{2016AsBio..16..465S,2017ARA&A..55..433K,2018AsBio..18..663S}.
...
%
rThis time-dependent interaction is described by Maxwell's equations,
...
\begin{equation}
\label{eq:angular_spectrum2\textbf{r}}
\mathcal{E}(x, y, z') = \mathcal{F}_{x,y}^{-1}\{e^{-ik_z(z'-z)}\mathcal{F}_{x,y}\{\mathcal{E}(x,y,z)\}\}.
\end{equation}

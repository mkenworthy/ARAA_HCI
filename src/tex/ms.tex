...
%  \script{plot_scale_invariant_masks.py}
  ...
  \caption{Lyot coronagraph. Geometric rays show the propoagation from the focal plane mask between B and C, to the Lyot plane at D and E, with the final resultant image at F.}
  \label{fig:lyot}
\end{figure}
...
%2022 on sky EFC axel potier \citep{Potier22} and the first paper in the series on VLT/SPHERE is \citep{Potier20} and 

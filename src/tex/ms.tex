...
\begin{figure}[ht]
  ...
  \centering
  \includegraphics[width=0.9\linewidth]{figures/phasing_errors.pdf}
...
A flat wavefront would ideally result in a deep and dark coronagraphic image. However, coronagraphic dark holes are not completely free of starlight after wavefront flattening due to the existence of amplitude aberrations and higher-order phase frequency folding effects[TODO rephrase]. Instead of aiming to flatten the wavefront, \ac{hci} instruments aim to remove as much light as possible from the dark hole region. This is informally also called `dark hole digging' \citep{malbet1995high, borde2006high}.

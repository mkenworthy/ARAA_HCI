...
%
In this regime the propagation factor $k_z=\sqrt{n^2k^2 - k_{\perp}^2}\approx nk - \frac{k_{\perp}^2}{2nk}$
\begin{equation}
...
\begin{figure}[ht]
  ...
  \caption{Definition of planet throughput, showing the integrated flux over an aperture with increasing distance from the star.}
...
\begin{figure}[ht]
  \centering
  \script{plot_aplc.py}
  \includegraphics[width=0.8\linewidth]{figures/aplc.pdf}
  \caption{The APLC.}
  \label{fig:coro_aplc}
\end{figure}
...
%
Instead of being limited between $[0, 1]$, it is possible to use phase offsets to increase the range to $[-1, 1]$.
%
And, it also allows for complex value apodization.
%
...
%
Full circular dark holes are not very efficient since they require strong phase patterns to create the dark holes which causes significant Strehl loss \citep{Por17}.
%
One-sided dark holes are much more efficient in terms of Strehl. 
...
%
High coupling efficiency is possible (with a theoretical maximum of 81\% for an Airy core into the Gaussian HE$_{11}$ mode \citep{shaklan1988coupling}) and reflected light around the fibre used to sense and minimise speckles whilst the incoherent light of the planet remains constant and injected into the fibre. 
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/null2crossings.png}
...
\begin{figure}[ht]
  ...
  \caption{Imapct of piston errors on the coronagraphic image from the ELT.}

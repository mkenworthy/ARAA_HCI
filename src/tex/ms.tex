...
%
Figure~\ref{fig:coronagraph_focal_plane_definitions} shows the different types of coronagraphic dark hole gemetries commonly used with the definition of the \ac{iwa} and \ac{owa}.
